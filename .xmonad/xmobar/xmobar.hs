Config { 
   ...
   , commands = 
        ...
        -- CPU Usage
        [ Run Cpu ["-t", "<fc=#74c7ec><fn=1>󰘚</fn> <total>%</fc>"] 20

        -- Thermal zone
        , Run ThermalZone 0 ["-t","<fc=#cba6f7><fn=1></fn> <temp>°C</fc>"] 30
                          
        -- memory usage monitor
        , Run Memory         ["-t","<fc=#89b4fa><fn=1>󰍛</fn> <used>Mb</fc>"] 10
        ...
        -- Check for updates
        , Run Com ".scripts/pacupdate.sh" [] "pacupdate" 3600

        -- Check for volume
        , Run Com ".scripts/volume.sh" [] "volume" 20

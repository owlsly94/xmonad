...
volumeMute   = "amixer set 'Master' 0%"
volumeUnmute = "amixer set 'Master' 50%"
...
-----------------------------
powerMenu :: String
powerMenu = "rofi -show session-menu -modi session-menu:~/.xmonad/scripts/rofi-power-menu --choices=shutdown/reboot/logout/lockscreen"
...
-----------------------------
wallChanger :: String
wallChanger = "$HOME/.xmonad/scripts/feh-randomize.sh"
...
myWorkspaces = clickable . map xmobarEscape
               $ ["\60037 ", "\62057 ", "\61729 ", "\61564 ", "\61771 ", "\62002 ", "\61448 ", "\61441 ", "\61635 "]
  where
...
myManageHook = composeAll
             ...
             , className =? "whatsapp-nativefier-d40211" --> doShift ( myWorkspaces !! 5 )
...
main :: IO ()
main = do
    xmproc <- spawnPipe "xmobar $HOME/.xmonad/xmobar/xmobar.hs"
    xmonad . ewmh $
        myBaseConfig
                ...
                , logHook = dynamicLogWithPP xmobarPP
                          ...
                          , ppCurrent = xmobarColor "#a6e3a1" "" . wrap "" "" -- Current workspace in xmobar
                          , ppVisible = xmobarColor "#a6e3a1" ""                -- Visible but not current workspace
                          , ppHidden = xmobarColor "#cba6f7" "" . wrap "" ""   -- Hidden workspaces in xmobar
                          , ppHiddenNoWindows = xmobarColor "#45475a" ""        -- Hidden workspaces (no windows)
                          , ppTitle = xmobarColor "#cdd6f4" "" . shorten 80     -- Title of active window in xmobar
                          , ppSep =  "<fc=#f5e0dc>  \60272 </fc>"                     -- Separators in xmobar
                          , ppLayout = xmobarColor "#b4befe" "" . wrap "" " "
                          , ppWsSep = " "

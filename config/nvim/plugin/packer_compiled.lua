...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["lspkind.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/lspkind.nvim",
  ...
  ["nvim-notify"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/nvim-notify",
